...
#ifndef __SIMU_SIMUDEFS_H
#define __SIMU_SIMUDEFS_H

#include <omnetpp.h>

#define SIMU_VERSION 0x0202

#define SIMU_SIGNAL_PACKET_NAME          "packetName"
#define SIMU_SIGNAL_UWBIRPACKET_NAME     "uwbirpacket"
#define SIMU_SIGNAL_DROPPEDPACKET_NAME   "droppedpacket"
#define SIMU_SIGNAL_PASSEDMSG_NAME       "passedmsg"
#define SIMU_SIGNAL_HOSTSTATE_NAME       "hoststate"
#define SIMU_SIGNAL_MOBILITY_CHANGE_NAME "veinsmobilityStateChanged"
#define SIMU_SIGNAL_BATTERY_CHANGE_NAME  "batterystate"
#define SIMU_SIGNAL_MOBANMSG_NAME        "bbmobanmessage"

#if defined(SIMU_EXPORT)
#  define SIMU_API OPP_DLLEXPORT
#elif defined(SIMU_IMPORT)
#  define SIMU_API OPP_DLLIMPORT
#else
#  define SIMU_API
#endif
 ...
 */
class SIMU_API simsignalwrap_t
{
private:
