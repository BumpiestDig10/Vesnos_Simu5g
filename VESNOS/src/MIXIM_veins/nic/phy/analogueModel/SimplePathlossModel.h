 ...
 * @ingroup mapping
 */
class SIMU_API SimplePathlossConstMapping : public SimpleConstMapping
{
protected:
 ...
 * @ingroup analogueModels
 */
class SIMU_API SimplePathlossModel : public AnalogueModel
{
protected:
...
public:
	...
	SimplePathlossModel(double alpha, double carrierFrequency,
					bool useTorus, const inet::Coord& playgroundSize, bool debug):
	 ...
	 * method.
	 */
	virtual double calcPathloss(const inet::Coord& receiverPos, const inet::Coord& sendersPos);
};
