...
SimpleObstacleShadowing::SimpleObstacleShadowing(inet::ObstacleControl& obstacleControl, double carrierFrequency, bool useTorus, const inet::Coord& playgroundSize, bool debug) :
...
void SimpleObstacleShadowing::filterSignal(AirFrame *frame, const inet::Coord& sendersPos, const inet::Coord& receiverPos)
{
    EV_STATICCONTEXT
