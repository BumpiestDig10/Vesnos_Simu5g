 ...
 * @sa ChannelAccess
 */
class SIMU_API BaseConnectionManager : public omnetpp::cSimpleModule
{
private:
	/**
	...
	public:
		 ...
		 */
        GridCoord(const inet::Coord& c, const inet::Coord& gridCellSize = inet::Coord(1.0,1.0,1.0)) {
...
protected:
	...
	const inet::Coord* playgroundSize;
...
private:
     ...
     */
    GridCoord getCellForCoordinate(const inet::Coord& c);
...
protected:
	 ...
	 */
	virtual void updateConnections(int nicID, const inet::Coord* oldPos, const inet::Coord* newPos);
	/**
...
public:
	 ...
	 * "registerNicExt()".
	 */
	bool registerNic(omnetpp::cModule* nic, ChannelAccess* chAccess, const inet::Coord* nicPos);
	...
	void updateNicPos(int nicID, const inet::Coord* newPos);
