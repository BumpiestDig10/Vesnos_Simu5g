...
class SIMU_API MacToPhyControlInfo: public omnetpp::cObject
{
protected:
...
public:
    ...
    enum inet::PHY_MCS getMCS() {return this->mcs;};
    ...
    void setMCS(enum inet::PHY_MCS mcs) {this->mcs = mcs;};
};
