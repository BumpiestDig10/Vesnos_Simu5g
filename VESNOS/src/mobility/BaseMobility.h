...
class SIMU_API BaseMobility : public BaseModule
{
  public:
  ...
  public:
    ...
    virtual inet::Coord getCurrentPosition() const
    {
    ...
    virtual inet::Coord getCurrentSpeed() const
    {
  ...
  protected:
	...
	inet::Coord getRandomPosition() { return world->getRandomPosition();}
     ...
     * started.
     */
    BorderHandling checkIfOutside( inet::Coord, inet::Coord& );
