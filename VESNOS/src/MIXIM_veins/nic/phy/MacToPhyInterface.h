 ...
 * @ingroup phyLayer
 */
class SIMU_API MacToPhyInterface
{
public:
	/**
...
public:
    ...
    virtual omnetpp::simtime_t getFrameDuration(int payloadLengthBits, uint64_t bitrate, enum inet::PHY_MCS mcs = inet::MCS_DEFAULT) const = 0;
