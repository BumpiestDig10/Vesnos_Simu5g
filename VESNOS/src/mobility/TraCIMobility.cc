...
void TraCIMobilityMod::preInitialize(std::string external_id, const inet::Coord& position, std::string road_id, double speed, double angle)
{
...
void TraCIMobilityMod::nextPosition(const inet::Coord& position, std::string road_id, double speed, double angle, VehicleSignal vehSignals)
{
...
inet::Coord TraCIMobilityMod::calculateAntennaPosition(const inet::Coord& vehiclePos) const
{
	inet::Coord corPos;
