...
void SimplePathlossModel::filterSignal(AirFrame *frame, const inet::Coord& sendersPos, const inet::Coord& receiverPos)
{
    EV_STATICCONTEXT
...
double SimplePathlossModel::calcPathloss(const inet::Coord& receiverPos, const inet::Coord& sendersPos)
{
    EV_STATICCONTEXT
