...
public:
    ...
    const static omnetpp::simsignal_t catPacketSignal;

    /** @brief Signal for passed messages.*/
    const static omnetpp::simsignal_t catPassedMsgSignal;

    /** @brief Signal for dropped packets.*/
    const static omnetpp::simsignal_t catDroppedPacketSignal;
