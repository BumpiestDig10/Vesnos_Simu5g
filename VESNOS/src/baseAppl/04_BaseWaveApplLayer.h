...
protected:
    ...
    int myId;
    const char *myFullId;
    inet::Coord curPosition;  // OMNET++ position
    inet::Coord curSpeed;
...
protected:
    ...
    virtual omnetpp::simtime_t computeAsynchronousSendingTime(omnetpp::simtime_t interval);
};
