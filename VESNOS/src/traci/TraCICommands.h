...
public:
    ...
    void polygonAdd(std::string, std::string, const RGB, bool, int32_t, const std::list<inet::Coord>&);
    ...
    void poiAdd(std::string, std::string, const RGB, int32_t, const inet::Coord&);
    ...
    inet::Coord convertCoord_traci2omnet(TraCICoord coord) const;  // convert TraCI coordinates to OMNeT++ coordinates
    TraCICoord convertCoord_omnet2traci(inet::Coord coord) const;  // convert OMNeT++ coordinates to TraCI coordinates
