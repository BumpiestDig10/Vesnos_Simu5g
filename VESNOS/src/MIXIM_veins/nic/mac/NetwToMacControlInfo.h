 ...
 * @author Daniel Willkomm
 **/
class SIMU_API NetwToMacControlInfo : public omnetpp::cObject
{
  protected:
  ...
  public:
    ...
    NetwToMacControlInfo(const inet::MacAddress& addr = inet::MacAddress()) : omnetpp::cObject() , nextHopMac(addr)
    {
    };
     ...
     */
    static omnetpp::cObject *const setControlInfo(omnetpp::cMessage *const pMsg, const inet::MacAddress& pDestAddr);
    /**
     ...
     */
    static const inet::MacAddress& getDestFromControlInfo(const omnetpp::cObject *const pCtrlInfo);
};
