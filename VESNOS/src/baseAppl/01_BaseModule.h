...
/*
#ifndef EV_DEBUG
#define EV_DEBUG_clear EV
#define EV_DEBUG EV << logName() << "::" << getClassName() << ": "
#endif
...
class INET_API BaseModule: public omnetpp::cSimpleModule, public omnetpp::cListener
{
protected:
    ...
    const static omnetpp::simsignal_t catHostStateSignal;
