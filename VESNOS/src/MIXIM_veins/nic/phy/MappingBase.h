 ...
 * @ingroup mapping
 */
class SIMU_API DimensionSet : public std::set<Dimension>
{
public:
 ...
 * @ingroup mapping
 */
class SIMU_API ConstMappingIterator
{
public:
...
public:
    ...
    stream& print(stream&                out,
        ...
        simu::math::mW2dBm<argument_value_t>       fctor2dBm;
 ...
 * @ingroup mapping
 */
class SIMU_API MappingIterator:public ConstMappingIterator
{
public:
 ...
 * @ingroup mapping
 */
class SIMU_API Mapping:public ConstMapping
{
public:
 ...
 * @ingroup mapping
 */
class SIMU_API SimpleConstMappingIterator:public ConstMappingIterator
{
protected:
 ...
 * @ingroup mapping
 */
class SIMU_API SimpleConstMapping:public ConstMapping
{
protected:
