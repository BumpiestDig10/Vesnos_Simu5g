...
const omnetpp::simsignal_t BaseLayer::catPassedMsgSignal = registerSignal("passedmsgSignal");
const omnetpp::simsignal_t BaseLayer::catPacketSignal = registerSignal("packetNameSignal");
const omnetpp::simsignal_t BaseLayer::catDroppedPacketSignal = registerSignal("packetDroppedSignal");
