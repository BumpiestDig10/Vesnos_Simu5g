 ...
 * @ingroup phyLayer
 */
class SIMU_API RadioStateAnalogueModel : public AnalogueModel
{
 ...
 * @ingroup phyLayer
 */
class SIMU_API RSAMConstMappingIterator : public ConstMappingIterator
{
protected:
 ...
 * @ingroup phyLayer
 */
class SIMU_API RSAMMapping : public ConstMapping
{
protected:
