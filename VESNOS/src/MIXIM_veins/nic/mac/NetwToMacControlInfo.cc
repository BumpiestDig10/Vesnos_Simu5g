...
omnetpp::cObject *const NetwToMacControlInfo::setControlInfo(omnetpp::cMessage *const pMsg, const inet::MacAddress& pDestAddr)
{
...
const inet::MacAddress& NetwToMacControlInfo::getDestFromControlInfo(const cObject *const pCtrlInfo)
{
