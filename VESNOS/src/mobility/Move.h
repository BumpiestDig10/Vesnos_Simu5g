 ...
 * @author Andreas Koepke, Michael Swigulski
 **/
class INET_API Move : public omnetpp::cObject
{
protected:
...
public:
	 ...
	 */
	const inet::Coord& getStartPos() const
	{
		return startPos;
	}
	 ...
	 */
	void setStart(const inet::Coord& startPos, omnetpp::simtime_t_cref startTime)
	{
	 ...
	 */
	void setStart(const inet::Coord& startPos)
	{
	 ...
	 */
	const inet::Coord& getDirection() const
	{
		return direction;
	}
	 ...
	 * or too close to it.
	 */
	void setDirectionByTarget(const inet::Coord& target)
	{
     ...
     *
     */
    virtual inet::Coord getPositionAt(omnetpp::simtime_t_cref actualTime = omnetpp::simTime()) const
    {
    ...
    virtual const inet::Coord& getCurrentPosition() const
    {
