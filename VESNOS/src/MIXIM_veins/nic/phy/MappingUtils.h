 ...
 * @ingroup mappingDetails
 */
class SIMU_API FilteredMappingIterator : public BaseFilteredIterator<MappingIterator>
{
public:
 ...
 * @ingroup mappingDetails
 */
class SIMU_API LinearIntplMappingIterator:public MappingIterator
{
protected:
 ...
 * @ingroup mappingDetails
 */
class SIMU_API LinearIntplMapping:public Mapping
{
protected:
 ...
 * @ingroup mapping
 */
class SIMU_API ConstantSimpleConstMapping : public SimpleConstMapping
{
protected:
 ...
 * @ingroup mappingDetails
 */
class SIMU_API ConstMappingIteratorWrapper : public MappingIterator
{
protected:
 ...
 * @ingroup mappingDetails
 */
class SIMU_API ConstMappingWrapper : public Mapping
{
protected:
 ...
 * @ingroup mappingDetails
 */
class SIMU_API FilledUpMappingIterator : public MultiDimMappingIterator<Linear>
{
public:
 ...
 * @ingroup mappingDetails
 */
class SIMU_API FilledUpMapping : public MultiDimMapping<Linear>
{
public:
 ...
 * @ingroup mappingDetails
 */
class SIMU_API ConcatConstMappingIterator : public FilteredConstMappingIterator
{
protected:
 ...
 * @author Karl Wessel
 */
class SIMU_API ConstDelayedMapping: public BaseDelayedMapping<ConstMapping>
{
public:
 ...
 * @author Karl Wessel
 */
class SIMU_API DelayedMapping: public BaseDelayedMapping<Mapping>
{
public:
...
SIMU_API Mapping* operator*(const ConstMapping& f1, const ConstMapping& f2);
SIMU_API Mapping* operator/(const ConstMapping& f1, const ConstMapping& f2);
SIMU_API Mapping* operator+(const ConstMapping& f1, const ConstMapping& f2);
SIMU_API Mapping* operator-(const ConstMapping& f1, const ConstMapping& f2);
