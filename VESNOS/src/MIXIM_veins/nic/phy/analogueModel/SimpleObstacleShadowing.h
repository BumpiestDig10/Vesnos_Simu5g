...
protected:
    ...
    inet::ObstacleControl& obstacleControl;
...
public:
	 ...
	 */
	SimpleObstacleShadowing(inet::ObstacleControl& obstacleControl, double carrierFrequency, bool useTorus, const inet::Coord& playgroundSize, bool debug);

	/**
	 * @brief Filters a specified Signal by adding an attenuation
	 * over time to the Signal.
	 */
	virtual void filterSignal(AirFrame *frame, const inet::Coord& sendersPos, const inet::Coord& receiverPos);
};
