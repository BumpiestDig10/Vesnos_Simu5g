 ...
 * @author Karl Wessel
 */
class SIMU_API MacToNetwControlInfo : public omnetpp::cObject
{
protected:
...
public:
     ...
     */
    static omnetpp::cObject *const setControlInfo(omnetpp::cMessage *const pMsg, const inet::MacAddress& pSrcAddr)
    {
    ...
    static const inet::MacAddress& getAddress(omnetpp::cMessage *const pMsg)
    {
    	return getAddressFromControlInfo(pMsg->getControlInfo());
    }

    static const inet::MacAddress& getAddressFromControlInfo(omnetpp::cObject *const pCtrlInfo)
    {
