...
const simsignalwrap_t BaseLayer::catPassedMsgSignal     = simsignalwrap_t(SIMU_SIGNAL_PASSEDMSG_NAME);
const simsignalwrap_t BaseLayer::catPacketSignal        = simsignalwrap_t(SIMU_SIGNAL_PACKET_NAME);
const simsignalwrap_t BaseLayer::catDroppedPacketSignal = simsignalwrap_t(SIMU_SIGNAL_DROPPEDPACKET_NAME);
